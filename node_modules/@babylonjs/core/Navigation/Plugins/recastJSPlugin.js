...
var RecastJSCrowd = /** @class */ (function () {
    ...
    function RecastJSCrowd(plugin, maxAgents, maxAgentRadius, scene) {
         ...
         */
        this.agentDestinationArmed = new Array();
        /**
         * agent current target
         */
        this.agentDestination = new Array();
        /**
    ...
    RecastJSCrowd.prototype.update = function (deltaTime) {
        ...
        for (var index = 0; index < this.agents.length; index++) {
            ...
            if (this.agentDestinationArmed[index]) {
                var dx = agentPosition.x - this.agentDestination[index].x;
                var dz = agentPosition.z - this.agentDestination[index].z;
                var radius = this.reachRadii[index];
                var groundY = this.agentDestination[index].y - this.reachRadii[index];
                var ceilingY = this.agentDestination[index].y + this.reachRadii[index];
