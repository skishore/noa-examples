    ...
    ShaderCodeInliner.prototype._replaceFunctionCallsByCode = function () {
        ...
        for (var _i = 0, _a = this._functionDescr; _i < _a.length; _i++) {
            ...
            while (startIndex < this._sourceCode.length) {
                ...
                if (params === null) {
                    if (this.debug) {
                        console.warn("Invalid function call: can't extract the parameters of the function call. Function '" + name_1 + "' (type=" + type + "). callParamsStartIndex=" + callParamsStartIndex + ", callParams=" + callParams);
                    }
                    startIndex = functionCallIndex + name_1.length;
                    continue;
                }
                ...
                if (retParamName) {
                    ...
                    if (this.debug) {
                        console.log("Replace function call by code. Function '" + name_1 + "' (type=" + type + "). injectDeclarationIndex=" + injectDeclarationIndex + ", call parameters=" + paramNames);
                    }
                }
                else {
                    ...
                    if (this.debug) {
                        console.log("Replace function call by code. Function '" + name_1 + "' (type=" + type + "). functionCallIndex=" + functionCallIndex + ", call parameters=" + paramNames);
                    }
                }
                doAgain = true;
            }
