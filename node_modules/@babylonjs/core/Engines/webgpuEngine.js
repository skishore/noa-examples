...
var WebGPUEngine = /** @class */ (function (_super) {
    ...
    function WebGPUEngine(canvas, options) {
        ...
        _this._mainRenderPassCopyWrapper = new WebGPURenderPassWrapper();
        /** @hidden */
        ...
        _this._viewportsCurrent = [{ x: 0, y: 0, w: 0, h: 0 }, { x: 0, y: 0, w: 0, h: 0 }];
        _this._scissorsCurrent = [{ x: 0, y: 0, w: 0, h: 0 }, { x: 0, y: 0, w: 0, h: 0 }];
        ...
        Logger.Log("Babylon.js v" + Engine.Version + " - " + _this.description + " engine");
        if (!navigator.gpu) {
        ...
        _this._invertYFinalFramebuffer = (!!_this._options.forceCopyForInvertYFinalFramebuffer || !_this._canvas.style) && !_this._options.disableCopyForInvertYFinalFramebuffer;
        if (!_this._invertYFinalFramebuffer) {
            // if style does not exist, we are probably using an offscreen canvas
            if (_this._canvas.style) {
                _this._canvas.style.transform = "scaleY(-1)";
            }
        }
        return _this;
    }
    ...
    Object.defineProperty(WebGPUEngine, "IsSupportedAsync", {
         ...
         */
        get: function () {
            return !navigator.gpu ? Promise.resolve(false) : navigator.gpu.requestAdapter().then(function (adapter) { return !!adapter; }, function (rejected) { return false; }).catch(function (e) { return false; });
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(WebGPUEngine.prototype, "name", {
        /**
    ...
    WebGPUEngine.prototype.initAsync = function (glslangOptions, twgslOptions) {
        ...
        return this._initGlslang(glslangOptions !== null && glslangOptions !== void 0 ? glslangOptions : (_a = this._options) === null || _a === void 0 ? void 0 : _a.glslangOptions)
            ...
            return _this._tintWASM ?
                _this._tintWASM.initTwgsl(twgslOptions !== null && twgslOptions !== void 0 ? twgslOptions : (_a = _this._options) === null || _a === void 0 ? void 0 : _a.twgslOptions)
                    .then(function () {
            ...
            _this._device.addEventListener('uncapturederror', function (event) {
                if (++numUncapturedErrors < _this.numMaxUncapturedErrors) {
                    ...
                    Logger.Warn("WebGPU uncaptured error: too many warnings (" + _this.numMaxUncapturedErrors + "), no more warnings will be reported to the console for this engine.");
                }
            });
    ...
    WebGPUEngine.prototype._initGlslang = function (glslangOptions) {
        ...
        glslangOptions = __assign(__assign({}, WebGPUEngine._glslangDefaultOptions), glslangOptions);
    ...
    WebGPUEngine.prototype._mustUpdateViewport = function (renderPass) {
        ...
        var update = this._viewportsCurrent[index].x !== x || this._viewportsCurrent[index].y !== y ||
    ...
    WebGPUEngine.prototype._mustUpdateScissor = function (renderPass) {
        ...
        var update = this._scissorsCurrent[index].x !== x || this._scissorsCurrent[index].y !== y ||
     ...
     */
    WebGPUEngine.prototype.createIndexBuffer = function (indices, updatable) {
        var is32Bits = true;
        var view;
    ...
    /** @hidden */
    WebGPUEngine.prototype.bindBuffersDirectly = function (vertexBuffer, indexBuffer, vertexDeclaration, vertexStrideSize, effect) {
        throw "Not implemented on WebGPU";
    };
    /** @hidden */
    WebGPUEngine.prototype.updateAndBindInstancesBuffer = function (instancesBuffer, data, offsetLocations) {
        throw "Not implemented on WebGPU";
    };
    /**
    ...
    WebGPUEngine.prototype._getWGSLShader = function (source, type, defines, shaderVersion) {
        if (defines) {
    ...
    /** @hidden */
    WebGPUEngine.prototype.createRawShaderProgram = function (pipelineContext, vertexCode, fragmentCode, context, transformFeedbackVaryings) {
        if (transformFeedbackVaryings === void 0) { transformFeedbackVaryings = null; }
        throw "Not available on WebGPU";
    };
    /** @hidden */
    WebGPUEngine.prototype.createShaderProgram = function (pipelineContext, vertexCode, fragmentCode, defines, context, transformFeedbackVaryings) {
        if (transformFeedbackVaryings === void 0) { transformFeedbackVaryings = null; }
        throw "Not available on WebGPU";
    };
    /**
    ...
    /** @hidden */
    WebGPUEngine.prototype._getRGBABufferInternalSizedFormat = function (type, format) {
        return 5;
    };
    ...
    WebGPUEngine.prototype.createTexture = function (url, noMipmap, invertY, scene, samplingMode, onLoad, onError, buffer, fallback, format, forcedExtension, mimeType, loaderOptions, creationFlags, useSRGBBuffer) {
        ...
        return this._createTextureBase(url, noMipmap, invertY, scene, samplingMode, onLoad, onError, function (texture, extension, scene, img, invertY, noMipmap, isCompressed, processFunction, samplingMode) {
            var _a;
            ...
            if (!((_a = texture._hardwareTexture) === null || _a === void 0 ? void 0 : _a.underlyingResource)) { // the texture could have been created before reaching this point so don't recreate it if already existing
                ...
                if (WebGPUTextureHelper.IsImageBitmap(imageBitmap)) {
                    _this._textureHelper.updateTexture(imageBitmap, texture, imageBitmap.width, imageBitmap.height, texture.depth, gpuTextureWrapper.format, 0, 0, invertY, false, 0, 0, _this._uploadEncoder);
    ...
    WebGPUEngine.prototype.generateMipMapsForCubemap = function (texture, unbind) {
        var _a;
    ...
    /** @hidden */
    WebGPUEngine.prototype._setInternalTexture = function (name, texture, baseName, textureIndex) {
    ...
    WebGPUEngine.prototype._setTexture = function (channel, texture, isPartOfTextureArray, depthStencilTexture, name, baseName, textureIndex) {
    ...
    //                              Render Pass
    //------------------------------------------------------------------------------
    WebGPUEngine.prototype._startRenderTargetRenderPass = function (rtWrapper, setClearStates, clearColor, clearDepth, clearStencil) {
        var _a, _b, _c;
        ...
        var colorClearValue = !setClearStates ? WebGPUConstants.LoadOp.Load : clearColor ? clearColor : WebGPUConstants.LoadOp.Load;
        var depthClearValue = !setClearStates ? WebGPUConstants.LoadOp.Load : clearDepth ? (this.useReverseDepthBuffer ? this._clearReverseDepthValue : this._clearDepthValue) : WebGPUConstants.LoadOp.Load;
        var stencilClearValue = !setClearStates ? WebGPUConstants.LoadOp.Load : clearStencil ? this._clearStencilValue : WebGPUConstants.LoadOp.Load;
        if (rtWrapper._attachments && rtWrapper.isMulti) {
            ...
            for (var i = 0; i < this._mrtAttachments.length; ++i) {
                var index = this._mrtAttachments[i];
                if (index === 0) {
                    continue;
                }
                var mrtTexture = rtWrapper.textures[index - 1];
    ...
    WebGPUEngine.prototype._startMainRenderPass = function (setClearStates, clearColor, clearDepth, clearStencil) {
        ...
        var renderPassWrapperForSwapChain = this._invertYFinalFramebuffer ? this._mainRenderPassCopyWrapper : this._mainRenderPassWrapper;
    ...
    WebGPUEngine.prototype.setDitheringState = function (value) {
        // Does not exist in WebGPU
    };
    WebGPUEngine.prototype.setRasterizerState = function (value) {
        // Does not exist in WebGPU
    };
    /**
    ...
    //------------------------------------------------------------------------------
    /** @hidden */
    WebGPUEngine.prototype.bindSamplers = function (effect) { };
    /** @hidden */
    WebGPUEngine.prototype._bindTextureDirectly = function (target, texture, forTextureDataUpdate, force) {
    ...
    /** @hidden */
    WebGPUEngine.prototype._isRenderingStateCompiled = function (pipelineContext) {
        // No parallel shader compilation.
        return true;
    };
    /** @hidden */
    ...
    /** @hidden */
    WebGPUEngine.prototype.getUniforms = function (pipelineContext, uniformsNames) {
        return [];
    };
    /** @hidden */
    WebGPUEngine.prototype.setIntArray = function (uniform, array) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setIntArray2 = function (uniform, array) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setIntArray3 = function (uniform, array) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setIntArray4 = function (uniform, array) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setArray = function (uniform, array) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setArray2 = function (uniform, array) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setArray3 = function (uniform, array) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setArray4 = function (uniform, array) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setMatrices = function (uniform, matrices) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setMatrix3x3 = function (uniform, matrix) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setMatrix2x2 = function (uniform, matrix) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setFloat = function (uniform, value) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setFloat2 = function (uniform, x, y) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setFloat3 = function (uniform, x, y, z) {
        return false;
    };
    /** @hidden */
    WebGPUEngine.prototype.setFloat4 = function (uniform, x, y, z, w) {
        return false;
    };
