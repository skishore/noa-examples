...
var WebGPUCacheRenderPipeline = /** @class */ (function () {
    ...
    WebGPUCacheRenderPipeline.prototype.setMRTAttachments = function (attachments, textureArray) {
        var _a;
        ...
        var bits = [0, 0], indexBits = 0, mask = 0, numRT = 0;
        for (var i = 0; i < attachments.length; ++i) {
            var index = attachments[i];
            if (index === 0) {
                continue;
            }
            var texture = textureArray[index - 1];
    ...
    WebGPUCacheRenderPipeline.prototype._setRasterizationState = function (topology, sampleCount) {
        ...
        var rasterizationState = (frontFace - 1) +
            (cullMode << 1) +
            (clampDepth << 3) +
            (alphaToCoverage << 4) +
            (topology << 5) +
    ...
    WebGPUCacheRenderPipeline.prototype._setColorStates = function () {
        var colorStates = ((this._writeMask ? 1 : 0) << 22) + (this._colorFormat << 23) +
    ...
    WebGPUCacheRenderPipeline.prototype._setDepthStencilState = function () {
        ...
        var depthStencilState = this._depthStencilFormat +
    ...
    WebGPUCacheRenderPipeline.prototype._getVertexInputDescriptor = function (effect, topology) {
        var _a, _b;
        var descriptors = [];
        var webgpuPipelineContext = effect._pipelineContext;
        var attributes = webgpuPipelineContext.shaderProcessingContext.attributeNamesFromEffect;
    ...
    WebGPUCacheRenderPipeline.prototype._createRenderPipeline = function (effect, topology, sampleCount) {
        var webgpuPipelineContext = effect._pipelineContext;
        var inputStateDescriptor = this._getVertexInputDescriptor(effect, topology);
