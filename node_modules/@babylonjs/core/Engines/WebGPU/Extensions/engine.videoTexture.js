...
WebGPUEngine.prototype.updateVideoTexture = function (texture, video, invertY) {
    ...
    this.createImageBitmap(video).then(function (bitmap) {
        _this._textureHelper.updateTexture(bitmap, texture, texture.width, texture.height, texture.depth, gpuTextureWrapper.format, 0, 0, !invertY, false, 0, 0, _this._uploadEncoder);
