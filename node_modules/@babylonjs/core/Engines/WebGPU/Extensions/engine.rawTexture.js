...
WebGPUEngine.prototype.updateRawCubeTexture = function (texture, bufferView, format, type, invertY, compression, level) {
    if (compression === void 0) { compression = null; }
    ...
    var internalCallback = function (data) {
        ...
        if (mipmapGenerator) {
            ...
            for (var level = 0; level < mipData.length; level++) {
                ...
                _this._textureHelper.updateCubeTextures(allFaces, gpuTextureWrapper.underlyingResource, mipSize, mipSize, gpuTextureWrapper.format, invertY, false, 0, 0, _this._uploadEncoder);
            }
        }
        else {
            var allFaces = [];
