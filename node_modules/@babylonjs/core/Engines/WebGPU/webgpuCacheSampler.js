...
var WebGPUCacheSampler = /** @class */ (function () {
    ...
    WebGPUCacheSampler._GetSamplerDescriptor = function (sampler) {
        ...
        return __assign(__assign(__assign({}, filterDescriptor), this._GetSamplerWrappingDescriptor(sampler)), { compare: sampler._comparisonFunction ? WebGPUTextureHelper.GetCompareFunction(sampler._comparisonFunction) : undefined, maxAnisotropy: filterDescriptor.anisotropyEnabled ? anisotropy : 1 });
    };
