...
var PrePassRendererSceneComponent = /** @class */ (function () {
    ...
    PrePassRendererSceneComponent.prototype._beforeRenderTargetClearStage = function (renderTarget, faceIndex, layer) {
        if (this.scene.prePassRenderer) {
    ...
    PrePassRendererSceneComponent.prototype._afterCameraDraw = function (camera) {
        if (this.scene.prePassRenderer) {
