...
var OutlineRenderer = /** @class */ (function () {
    ...
    OutlineRenderer.prototype.render = function (subMesh, batch, useOverlay, renderPassId) {
        ...
        renderingMesh._processRendering(effectiveMesh, subMesh, effect, material.fillMode, batch, hardwareInstancedRendering, function (isInstance, world) { effect.setMatrix("world", world); });
        engine.setZOffset(0);
    ...
    OutlineRenderer.prototype.isReady = function (subMesh, useInstances, renderPassId) {
        ...
        if (cachedDefines !== join) {
            drawWrapper.setEffect(this.scene.getEngine().createEffect("outline", attribs, ["world", "mBones", "viewProjection", "diffuseMatrix", "offset", "color", "logarithmicDepthConstant",
                "morphTargetInfluences", "morphTargetTextureInfo", "morphTargetTextureIndices"], ["diffuseSampler", "morphTargets"], join, undefined, undefined, undefined, { maxSimultaneousMorphTargets: numMorphInfluencers }), join);
        }
