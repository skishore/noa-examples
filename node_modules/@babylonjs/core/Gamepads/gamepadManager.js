...
var GamepadManager = /** @class */ (function () {
    ...
    GamepadManager.prototype._addNewGamepad = function (gamepad) {
        ...
        if (xboxOne || gamepad.id.search("Xbox 360") !== -1
            || gamepad.id.search("xinput") !== -1
            || (gamepad.id.search("045e") !== -1 && gamepad.id.search("Surface Dock") === -1)) { // make sure the Surface Dock Extender is not detected as an xbox controller
