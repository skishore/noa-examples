...
var SceneDepthBlock = /** @class */ (function (_super) {
    ...
    SceneDepthBlock.prototype.bind = function (effect, nodeMaterial, mesh) {
    ...
    __decorate([
        editableInPropertyPage("Use non linear depth", PropertyTypeForEdition.Boolean, "ADVANCED", { notifiers: { "activatePreviewCommand": true, "callback": function (scene) { return scene.disableDepthRenderer(); } } })
    ], SceneDepthBlock.prototype, "useNonLinearDepth", void 0);
    __decorate([
        editableInPropertyPage("Force 32 bits float", PropertyTypeForEdition.Boolean, "ADVANCED", { notifiers: { "activatePreviewCommand": true, "callback": function (scene) { return scene.disableDepthRenderer(); } } })
