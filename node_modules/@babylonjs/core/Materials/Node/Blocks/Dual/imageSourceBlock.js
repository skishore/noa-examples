...
var ImageSourceBlock = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ImageSourceBlock.prototype, "texture", {
        ...
        set: function (texture) {
            ...
            var scene = (_a = texture === null || texture === void 0 ? void 0 : texture.getScene()) !== null && _a !== void 0 ? _a : Engine.LastCreatedScene;
            if (!texture && scene) {
    ...
    ImageSourceBlock.prototype.bind = function (effect, nodeMaterial, mesh) {
        if (!this.texture) {
            return;
        }
