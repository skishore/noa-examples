...
var TrigonometryBlock = /** @class */ (function (_super) {
    ...
    TrigonometryBlock.prototype._dumpPropertiesCode = function () {
        var codeString = _super.prototype._dumpPropertiesCode.call(this) + (this._codeVariableName + ".operation = BABYLON.TrigonometryBlockOperations." + TrigonometryBlockOperations[this.operation] + ";\r\n");
        return codeString;
    };
    return TrigonometryBlock;
}(NodeMaterialBlock));
