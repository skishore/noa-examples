...
var InputBlock = /** @class */ (function (_super) {
    ...
    */
    ...
    InputBlock.prototype._dumpPropertiesCode = function () {
        ...
        if (this.isAttribute) {
            return _super.prototype._dumpPropertiesCode.call(this) + (variableName + ".setAsAttribute(\"" + this.name + "\");\r\n");
        }
        if (this.isSystemValue) {
            return _super.prototype._dumpPropertiesCode.call(this) + (variableName + ".setAsSystemValue(BABYLON.NodeMaterialSystemValues." + NodeMaterialSystemValues[this._systemValue] + ");\r\n");
        }
        if (this.isUniform) {
            var codes = [];
            var valueString = "";
