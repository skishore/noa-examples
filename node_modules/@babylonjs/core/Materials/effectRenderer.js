...
var EffectRenderer = /** @class */ (function () {
    ...
    function EffectRenderer(engine, options) {
        ...
        this._onContextRestoredObserver = engine.onContextRestoredObservable.add(function () {
            _this._indexBuffer = engine.createIndexBuffer(options.indices);
    ...
    EffectRenderer.prototype.render = function (effectWrapper, outputTexture) {
        ...
        // Reset state
        this.setViewport();
        var out = outputTexture === null ? null : this.isRenderTargetTexture(outputTexture) ? outputTexture.renderTarget : outputTexture;
        if (out) {
