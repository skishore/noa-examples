...
var Texture = /** @class */ (function (_super) {
    ...
    function Texture(url, sceneOrEngine, noMipmapOrOptions, invertY, samplingMode, onLoad, onError, buffer, deleteBuffer, format, mimeType, loaderOptions, creationFlags) {
        ...
        if (typeof noMipmapOrOptions === 'object' && noMipmapOrOptions !== null) {
            ...
            invertY = (_b = noMipmapOrOptions.invertY) !== null && _b !== void 0 ? _b : true;
        ...
        _this._texture = _this._getFromCache(_this.url, noMipmap, samplingMode, invertY, useSRGBBuffer);
        if (!_this._texture) {
            if (!scene || !scene.useDelayedTextureLoading) {
                try {
                    _this._texture = engine.createTexture(_this.url, noMipmap, invertY, scene, samplingMode, load, errorHandler, _this._buffer, undefined, _this._format, null, mimeType, loaderOptions, creationFlags, useSRGBBuffer);
                }
                catch (e) {
        ...
        var texture = SerializationHelper.Parse(function () {
            ...
            if (parsedTexture.mirrorPlane) {
                ...
                if (parsedTexture.base64String) {
                    texture = Texture.CreateFromBase64String(parsedTexture.base64String, parsedTexture.name, scene, !generateMipMaps, parsedTexture.invertY, parsedTexture.samplingMode, onLoaded, (_b = parsedTexture._creationFlags) !== null && _b !== void 0 ? _b : 0, (_c = parsedTexture._useSRGBBuffer) !== null && _c !== void 0 ? _c : false);
                }
                else {
                    var url = void 0;
