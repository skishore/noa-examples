...
var ProceduralTexture = /** @class */ (function (_super) {
    ...
    function ProceduralTexture(name, size, fragment, scene, fallbackTexture, generateMipMaps, isCube, textureType) {
        ...
        if (isCube) {
            _this._rtWrapper = _this._fullEngine.createRenderTargetCubeTexture(size, { generateMipMaps: generateMipMaps, generateDepthBuffer: false, generateStencilBuffer: false, type: textureType });
            _this.setFloat("face", 0);
        }
        else {
            _this._rtWrapper = _this._fullEngine.createRenderTargetTexture(size, { generateMipMaps: generateMipMaps, generateDepthBuffer: false, generateStencilBuffer: false, type: textureType });
        }
        _this._texture = _this._rtWrapper.texture;
        // VBO
        var vertices = [];
        vertices.push(1, 1);
        vertices.push(-1, 1);
    ...
    ProceduralTexture.prototype.resize = function (size, generateMipMaps) {
        ...
        this._rtWrapper = this._fullEngine.createRenderTargetTexture(size, { generateMipMaps: generateMipMaps, generateDepthBuffer: false, generateStencilBuffer: false, type: this._textureType });
