...
var ShadowGenerator = /** @class */ (function () {
    ...
    ShadowGenerator.prototype._renderSubMeshForShadowMap = function (subMesh, isTransparent) {
        ...
        if (this.isReady(subMesh, hardwareInstancedRendering, isTransparent)) {
            ...
            // Draw
            renderingMesh._processRendering(effectiveMesh, subMesh, effect_1, material.fillMode, batch, hardwareInstancedRendering, function (isInstance, worldOverride, effectiveMaterial, effectiveMeshOverride) {
                if (effectiveMeshOverride && effectiveMesh !== effectiveMeshOverride) {
                    effectiveMeshOverride.getMeshUniformBuffer().bindToEffect(effect_1, "Mesh");
