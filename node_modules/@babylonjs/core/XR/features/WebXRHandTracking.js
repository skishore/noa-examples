...
var WebXRHandTracking = /** @class */ (function (_super) {
    ...
    options) {
        ...
        _this._attachHand = function (xrController) {
            ...
            if (!xrController.inputSource.hand ||
                ...
                !_this._handResources.jointMeshes) {
                return;
            }
        ...
        if (anyJointMeshOptions) {
            ...
            if (typeof anyJointMeshOptions.rigMapping !== "undefined") {
                ...
                [[anyJointMeshOptions.rigMapping.left, leftRigMapping],
                    [anyJointMeshOptions.rigMapping.right, rightRigMapping]].forEach(function (rigMappingTuple) {
    ...
    WebXRHandTracking._generateTrackedJointMeshes = function (featureOptions) {
        ...
        ["left", "right"].map(function (handedness) {
            ...
            for (var i = 0; i < handJointReferenceArray.length; ++i) {
                var newInstance = originalMesh.createInstance(handedness + "-handJoint-" + i);
    ...
    WebXRHandTracking._generateDefaultHandMeshesAsync = function (scene, options) {
        ...
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            var riggedMeshes, rightHandGLB, leftHandGLB, handShader, handColors, handNodes;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        riggedMeshes = {};
                        return [4 /*yield*/, SceneLoader.ImportMeshAsync("", WebXRHandTracking.DEFAULT_HAND_MODEL_BASE_URL, WebXRHandTracking.DEFAULT_HAND_MODEL_RIGHT_FILENAME, scene)];
                    case 1:
                        rightHandGLB = _b.sent();
                        return [4 /*yield*/, SceneLoader.ImportMeshAsync("", WebXRHandTracking.DEFAULT_HAND_MODEL_BASE_URL, WebXRHandTracking.DEFAULT_HAND_MODEL_LEFT_FILENAME, scene)];
                    case 2:
                        leftHandGLB = _b.sent();
                    ...
                    case 3:
                        ...
                        handColors = __assign({ base: Color3.FromInts(116, 63, 203), fresnel: Color3.FromInts(149, 102, 229), fingerColor: Color3.FromInts(177, 130, 255), tipFresnel: Color3.FromInts(220, 200, 255) }, (_a = options === null || options === void 0 ? void 0 : options.handMeshes) === null || _a === void 0 ? void 0 : _a.customColors);
                        handNodes = {
                        ...
                        ["left", "right"].forEach(function (handedness) {
                            var handGLB = handedness == "left" ? leftHandGLB : rightHandGLB;
    ...
    WebXRHandTracking._generateDefaultHandMeshRigMapping = function (handedness) {
        ...
        return _a = {},
            _a["wrist" /* WRIST */] = "wrist_" + H,
            _a["thumb-metacarpal" /* THUMB_METACARPAL */] = "thumb_metacarpal_" + H,
            _a["thumb-phalanx-proximal" /* THUMB_PHALANX_PROXIMAL */] = "thumb_proxPhalanx_" + H,
            _a["thumb-phalanx-distal" /* THUMB_PHALANX_DISTAL */] = "thumb_distPhalanx_" + H,
            _a["thumb-tip" /* THUMB_TIP */] = "thumb_tip_" + H,
            _a["index-finger-metacarpal" /* INDEX_FINGER_METACARPAL */] = "index_metacarpal_" + H,
            _a["index-finger-phalanx-proximal" /* INDEX_FINGER_PHALANX_PROXIMAL */] = "index_proxPhalanx_" + H,
            _a["index-finger-phalanx-intermediate" /* INDEX_FINGER_PHALANX_INTERMEDIATE */] = "index_intPhalanx_" + H,
            _a["index-finger-phalanx-distal" /* INDEX_FINGER_PHALANX_DISTAL */] = "index_distPhalanx_" + H,
            _a["index-finger-tip" /* INDEX_FINGER_TIP */] = "index_tip_" + H,
            _a["middle-finger-metacarpal" /* MIDDLE_FINGER_METACARPAL */] = "middle_metacarpal_" + H,
            _a["middle-finger-phalanx-proximal" /* MIDDLE_FINGER_PHALANX_PROXIMAL */] = "middle_proxPhalanx_" + H,
            _a["middle-finger-phalanx-intermediate" /* MIDDLE_FINGER_PHALANX_INTERMEDIATE */] = "middle_intPhalanx_" + H,
            _a["middle-finger-phalanx-distal" /* MIDDLE_FINGER_PHALANX_DISTAL */] = "middle_distPhalanx_" + H,
            _a["middle-finger-tip" /* MIDDLE_FINGER_TIP */] = "middle_tip_" + H,
            _a["ring-finger-metacarpal" /* RING_FINGER_METACARPAL */] = "ring_metacarpal_" + H,
            _a["ring-finger-phalanx-proximal" /* RING_FINGER_PHALANX_PROXIMAL */] = "ring_proxPhalanx_" + H,
            _a["ring-finger-phalanx-intermediate" /* RING_FINGER_PHALANX_INTERMEDIATE */] = "ring_intPhalanx_" + H,
            _a["ring-finger-phalanx-distal" /* RING_FINGER_PHALANX_DISTAL */] = "ring_distPhalanx_" + H,
            _a["ring-finger-tip" /* RING_FINGER_TIP */] = "ring_tip_" + H,
            _a["pinky-finger-metacarpal" /* PINKY_FINGER_METACARPAL */] = "little_metacarpal_" + H,
            _a["pinky-finger-phalanx-proximal" /* PINKY_FINGER_PHALANX_PROXIMAL */] = "little_proxPhalanx_" + H,
            _a["pinky-finger-phalanx-intermediate" /* PINKY_FINGER_PHALANX_INTERMEDIATE */] = "little_intPhalanx_" + H,
            _a["pinky-finger-phalanx-distal" /* PINKY_FINGER_PHALANX_DISTAL */] = "little_distPhalanx_" + H,
            _a["pinky-finger-tip" /* PINKY_FINGER_TIP */] = "little_tip_" + H,
            _a;
    };
    /**
    ...
    WebXRHandTracking.prototype.attach = function () {
        ...
        if (!((_c = this.options.handMeshes) === null || _c === void 0 ? void 0 : _c.customMeshes) && !((_d = this.options.handMeshes) === null || _d === void 0 ? void 0 : _d.disableDefaultMeshes)) {
            WebXRHandTracking._generateDefaultHandMeshesAsync(Engine.LastCreatedScene, this.options).then(function (defaultHandMeshes) {
                var _a, _b;
