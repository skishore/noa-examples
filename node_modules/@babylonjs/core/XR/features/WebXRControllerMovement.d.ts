 ...
 */
export declare type WebXRControllerMovementFeatureContext = {
    movementEnabled: boolean;
    movementOrientationFollowsViewerPose: boolean;
    movementSpeed: number;
    movementThreshold: number;
 ...
 */
export declare type WebXRControllerMovementState = {
    moveX: number;
    moveY: number;
    rotateX: number;
    rotateY: number;
 ...
 */
export declare type WebXRControllerMovementRegistrationConfiguration = {
    /**
