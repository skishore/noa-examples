                    ...
                    case 1:
                        ...
                        results.forEach(function (supported, i) {
                            if (supported) {
                                ...
                                Tools.Warn("Session mode \"" + _this._buttons[i].sessionMode + "\" not supported in browser");
                            }
                        });
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this._helper.enterXRAsync(this._buttons[idx].sessionMode, this._buttons[idx].referenceSpaceType, this._renderTarget, { optionalFeatures: this.options.optionalFeatures, requiredFeatures: this.options.requiredFeatures })];
                    case 4:
                        _a.sent();
