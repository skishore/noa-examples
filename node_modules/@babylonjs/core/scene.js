...
var Scene = /** @class */ (function (_super) {
    ...
    Scene.prototype.bindEyePosition = function (effect, variableName, isVector3) {
        ...
        var eyePosition = this._forcedViewPosition ? this._forcedViewPosition :
    ...
    */
    ...
    Scene.prototype._processSubCameras = function (camera, bindFrameBuffer) {
        if (bindFrameBuffer === void 0) { bindFrameBuffer = true; }
        if (camera.cameraRigMode === 0 || (camera.outputRenderTarget && camera.outputRenderTarget.getViewCount() > 1 && this.getEngine().getCaps().multiview)) {
    ...
    Scene.prototype.checkCameraRenderTarget = function (camera) {
        var _a;
     ...
     */
    Scene.prototype.resetDrawCache = function () {
        if (!this.meshes) {
            return;
        }
        for (var _i = 0, _a = this.meshes; _i < _a.length; _i++) {
    ...
    Scene.prototype.dispose = function () {
        ...
        for (var _c = 0, _d = this._activeRequests; _c < _d.length; _c++) {
            var request = _d[_c];
            request.abort();
        }
        // Events
