...
var PolygonMeshBuilder = /** @class */ (function () {
    ...
    PolygonMeshBuilder.prototype.buildVertexData = function (depth, smoothingThreshold) {
        ...
        if (depth > 0) {
            ...
            this._holes.forEach(function (hole) {
                _this.addSide(positions, normals, uvs, indices, bounds, hole, depth, true, smoothingThreshold);
            });
        }
     ...
     */
    PolygonMeshBuilder.prototype.addSide = function (positions, normals, uvs, indices, bounds, points, depth, flip, smoothingThreshold) {
