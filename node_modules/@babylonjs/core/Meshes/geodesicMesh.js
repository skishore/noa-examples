...
var _PrimaryIsoTriangle = /** @class */ (function () {
    function _PrimaryIsoTriangle() {
        ...
        this.isoVecsBAOA = [];
        this.vertexTypes = [];
        this.IDATA = new PolyhedronData("icosahedron", "Regular", [[0, PHI, -1], [-PHI, 1, 0], [-1, 0, -PHI], [1, 0, -PHI], [PHI, 1, 0], [0, PHI, 1], [-1, 0, PHI], [-PHI, -1, 0], [0, -PHI, -1], [PHI, -1, 0], [1, 0, PHI], [0, -PHI, 1]], [
    ...
    */
    ...
    _PrimaryIsoTriangle.prototype.setIndices = function () {
        ...
        for (var f = 0; f < 20; f++) { //f current face
        ...
        function matchIdx(f, fr, isoId, isoIdR) {
            idx = f + "|" + isoId;
            idxR = fr + "|" + isoIdR;
...
var GeodesicData = /** @class */ (function (_super) {
     ...
     * @hidden
     */
    GeodesicData.prototype.toGoldbergData = function () {
        var _this = this;
        var goldbergData = new PolyhedronData("GeoDual", "Goldberg", [], []);
