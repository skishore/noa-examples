...
var DeviceSourceManager = /** @class */ (function () {
    ...
    function DeviceSourceManager(engine) {
        ...
        this._deviceInputSystem.onDeviceConnectedObservable.add(function (eventData) {
            _this._addDevice(eventData.deviceType, eventData.deviceSlot);
            _this.onDeviceConnectedObservable.notifyObservers(_this.getDeviceSource(eventData.deviceType, eventData.deviceSlot));
        });
        this._deviceInputSystem.onDeviceDisconnectedObservable.add(function (eventData) {
            var device = _this.getDeviceSource(eventData.deviceType, eventData.deviceSlot); // Grab local reference to use before removing from devices
            _this._removeDevice(eventData.deviceType, eventData.deviceSlot);
            _this.onDeviceDisconnectedObservable.notifyObservers(device);
        });
        this._deviceInputSystem.onInputChangedObservable.add(function (eventData) {
            var _a;
            (_a = _this.getDeviceSource(eventData.deviceType, eventData.deviceSlot)) === null || _a === void 0 ? void 0 : _a.onInputChangedObservable.notifyObservers(eventData);
        });
    }
    // Public Functions
    /**
