...
var VolumetricLightScatteringPostProcess = /** @class */ (function (_super) {
    ...
    VolumetricLightScatteringPostProcess.prototype._isReady = function (subMesh, useInstances) {
        ...
        if (this._cachedDefines !== join) {
            ...
            this._volumetricLightScatteringPass.effect = mesh.getScene().getEngine().createEffect("volumetricLightScatteringPass", attribs, ["world", "mBones", "viewProjection", "diffuseMatrix"], ["diffuseSampler"], join, undefined, undefined, undefined, { maxSimultaneousMorphTargets: mesh.numBoneInfluencers });
        }
    ...
    VolumetricLightScatteringPostProcess.prototype._createPass = function (scene, ratio) {
        ...
        var renderSubMesh = function (subMesh) {
            ...
            if (_this._isReady(subMesh, hardwareInstancedRendering)) {
                ...
                // Draw
                renderingMesh._processRendering(effectiveMesh, subMesh, effect_1, Material.TriangleFillMode, batch, hardwareInstancedRendering, function (isInstance, world) { return effect_1.setMatrix("world", world); });
            }
        };
