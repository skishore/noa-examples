...
export var GetEnvironmentBRDFTexture = function (scene) {
    if (!scene.environmentBRDFTexture) {
        ...
        var texture = Texture.CreateFromBase64String(_environmentBRDFBase64Texture, "EnvironmentBRDFTexture" + _instanceNumber++, scene, true, false, Texture.BILINEAR_SAMPLINGMODE);
        ...
        scene.getEngine().onContextRestoredObservable.add(function () {
            texture.isRGBD = true;
