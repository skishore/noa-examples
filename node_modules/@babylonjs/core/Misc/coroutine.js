...
/** @hidden */
export function inlineScheduler(coroutine, onSuccess, onError) {
    try {
...
export function createYieldingScheduler(yieldAfterMS) {
    ...
    var startTime;
    return function (coroutine, onSuccess, onError) {
...
export function runCoroutine(coroutine, scheduler, onSuccess, onError, abortSignal) {
    function resume() {
        if (!abortSignal || !abortSignal.aborted) {
            scheduler(coroutine, function (stepResult) {
                if (stepResult.done) {
...
export function runCoroutineSync(coroutine, abortSignal) {
    ...
    var result;
    runCoroutine(coroutine, inlineScheduler, function (r) { return result = r; }, function (e) { throw e; }, abortSignal);
