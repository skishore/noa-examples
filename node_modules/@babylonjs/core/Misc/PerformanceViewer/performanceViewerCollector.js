...
var PerformanceViewerCollector = /** @class */ (function () {
     ...
     */
    PerformanceViewerCollector.prototype.registerEvent = function (name, forceUpdate) {
        var _this = this;
        var _a;
    ...
    PerformanceViewerCollector.prototype.addCollectionStrategies = function () {
        ...
        for (var _a = 0, strategyCallbacks_1 = strategyCallbacks; _a < strategyCallbacks_1.length; _a++) {
            var strategyCallback = strategyCallbacks_1[_a];
     ...
     */
    PerformanceViewerCollector.prototype.loadFromFileData = function (data) {
        ...
        this._strategies.clear();
        // populate metadata.
        for (var _a = 0, _b = this.datasets.ids; _a < _b.length; _a++) {
            var id = _b[_a];
    ...
    PerformanceViewerCollector.prototype.exportDataToCsv = function () {
        ...
        var fileName = new Date().toISOString() + "-perfdata.csv";
