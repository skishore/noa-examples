...
var EffectLayer = /** @class */ (function () {
    ...
    EffectLayer.prototype._isReady = function (subMesh, useInstances, emissiveTexture) {
        ...
        if (cachedDefines !== join) {
            drawWrapper.setEffect(this._engine.createEffect("glowMapGeneration", attribs, ["world", "mBones", "viewProjection",
                "glowColor", "morphTargetInfluences", "boneTextureWidth",
                "diffuseMatrix", "emissiveMatrix", "opacityMatrix", "opacityIntensity",
                "morphTargetTextureInfo", "morphTargetTextureIndices"], ["diffuseSampler", "emissiveSampler", "opacitySampler", "boneSampler", "morphTargets"], join, fallbacks, undefined, undefined, { maxSimultaneousMorphTargets: morphInfluencers }), join);
        }
    ...
    EffectLayer.prototype.render = function () {
        ...
        // Check
        var isReady = true;
        for (var i_1 = 0; i_1 < numDraws; ++i_1) {
            var currentEffect = this._mergeDrawWrapper[i_1];
            if (!currentEffect) {
                currentEffect = this._mergeDrawWrapper[i_1] = new DrawWrapper(this._engine);
        ...
        var previousAlphaMode = engine.getAlphaMode();
        for (var i_2 = 0; i_2 < numDraws; ++i_2) {
            var currentEffect = this._mergeDrawWrapper[i_2];
            // Render
            ...
            this._internalRender(currentEffect.effect, i_2);
        }
        // Restore Alpha
        engine.setAlphaMode(previousAlphaMode);
